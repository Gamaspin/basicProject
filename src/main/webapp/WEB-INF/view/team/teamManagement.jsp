            ...
            <div class="con-area he100p">
                ...
                <div class="con-box-area w100">
                    <div class="con-box_top">
                        ...
                        <button type="button" class="WriteBtn" onClick="location.href='/board/write'">글쓰기</button>

                        <button type="button" class="WriteBtn" onClick="location.href='/member/login'">로그인</button>
                                ...
                                <div>
                                    <c:forEach items="${listAllArticle}" var="listAll">
                                        <tr>
                                            ...
                                            <td onClick="location.href='javascript:selectArticle(${listAll.bno});'">${listAll.title}</td>
